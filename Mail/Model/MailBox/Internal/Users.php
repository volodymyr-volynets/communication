...
class Users extends \Object\Table {
	...
	public $pk = ['ml_internalmboxorg_tenant_id', 'ml_internalmboxorg_internalmailbox_id', 'ml_internalmboxorg_user_id'];
	public $tenant = true;
	public $orderby = [
	...
	public $columns = [
		...
		'ml_internalmboxorg_user_id' => ['name' => 'User #', 'domain' => 'user_id'],
		'ml_internalmboxorg_inactive' => ['name' => 'Inactive', 'type' => 'boolean']
	];
	public $constraints = [
		'ml_internal_mailbox_users_pk' => ['type' => 'pk', 'columns' => ['ml_internalmboxorg_tenant_id', 'ml_internalmboxorg_internalmailbox_id', 'ml_internalmboxorg_user_id']],
		...
		'ml_internalmboxorg_user_id_fk' => [
			'type' => 'fk',
			'columns' => ['ml_internalmboxorg_tenant_id', 'ml_internalmboxorg_user_id'],
