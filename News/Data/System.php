...
namespace Numbers\Communication\News\Data;
class System extends \Object\Import {
	public $data = [
		'controllers' => [
			...
			'data' => [
				[
					'sm_resource_id' => '::id::\Numbers\Communication\News\Controller\Categories',
					'sm_resource_code' => '\Numbers\Communication\News\Controller\Categories',
					...
					'sm_resource_group2_name' => 'News Management',
				...
				[
					'sm_resource_id' => '::id::\Numbers\Communication\News\Controller\News',
					'sm_resource_code' => '\Numbers\Communication\News\Controller\News',
					'sm_resource_type' => 100,
					'sm_resource_classification' => 'Global',
				...
				[
					'sm_resource_id' => '::id::\Numbers\Communication\News\Controller\Preview',
				...
				[
					'sm_resource_id' => '::id::\Numbers\Communication\News\Controller\\OpenAccess\Preview',
					'sm_resource_code' => '\Numbers\Communication\News\Controller\OpenAccess\Preview',
					'sm_resource_type' => 100,
					'sm_resource_classification' => 'Global',
					'sm_resource_name' => 'N/S News Preview (Open Access)',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'fas fa-newspaper',
					'sm_resource_module_code' => 'NS',
					'sm_resource_group1_name' => 'Account',
					...
					'sm_resource_menu_url' => null,
					'sm_resource_menu_options_generator' => null,
					'sm_resource_template_name' => 'main',
					'sm_resource_inactive' => 0,
					'\Numbers\Backend\System\Modules\Model\Resource\Features' => [
						[
							'sm_rsrcftr_feature_code' => 'NS::NEWS',
		...
		'menu' => [
			...
			'data' => [
				[
					'sm_resource_id' => '::id::\Menu\Operations\Communication\News\Management',
					'sm_resource_code' => '\Menu\Operations\Communication\News\Management',
				...
				[
					'sm_resource_id' => '::id::\Menu\Numbers\Communication\News\Controller\Categories',
					'sm_resource_code' => '\Menu\Numbers\Communication\News\Controller\Categories',
					...
					'sm_resource_acl_authorized' => 0,
					'sm_resource_acl_permission' => 1,
					'sm_resource_menu_acl_resource_id' => '::id::\Numbers\Communication\News\Controller\Categories',
					'sm_resource_menu_acl_method_code' => 'Index',
					'sm_resource_menu_acl_action_id' => '::id::List_View',
					'sm_resource_menu_url' => '/Numbers/Communication/News/Controller/Categories',
					'sm_resource_menu_options_generator' => null,
					'sm_resource_inactive' => 0
				],
				[
					'sm_resource_id' => '::id::\Menu\Numbers\Communication\News\Controller\News',
					'sm_resource_code' => '\Menu\Numbers\Communication\News\Controller\News',
					'sm_resource_type' => 200,
					...
					'sm_resource_acl_authorized' => 0,
					'sm_resource_acl_permission' => 1,
					'sm_resource_menu_acl_resource_id' => '::id::\Numbers\Communication\News\Controller\News',
					'sm_resource_menu_acl_method_code' => 'Index',
					'sm_resource_menu_acl_action_id' => '::id::List_View',
					'sm_resource_menu_url' => '/Numbers/Communication/News/Controller/News',
					'sm_resource_menu_options_generator' => null,
					'sm_resource_inactive' => 0
				],
				[
					'sm_resource_id' => '::id::\Menu\Numbers\Communication\News\Controller\Preview',
					'sm_resource_code' => '\Menu\Numbers\Communication\News\Controller\Preview',
					...
					'sm_resource_menu_acl_method_code' => null,
					'sm_resource_menu_acl_action_id' => null,
					'sm_resource_menu_url' => '/Numbers/Communication/News/Controller/Preview',
					'sm_resource_menu_options_generator' => null,
					'sm_resource_menu_name_generator' => '/Numbers/Communication/News/Controller/Preview/_JsonMenuName',
					'sm_resource_menu_order' => 32100,
					'sm_resource_inactive' => 0
				],
				/*
				[
					'sm_resource_id' => '::id::\Menu\Numbers\Communication\News\Controller\Preview\Top',
					'sm_resource_code' => '\Menu\Numbers\Communication\News\Controller\Preview\Top',
					'sm_resource_type' => 220,
					'sm_resource_name' => 'News',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'fas fa-newspaper',
					'sm_resource_module_code' => 'NS',
					'sm_resource_group1_name' => 'Resources',
					'sm_resource_group2_name' => null,
					'sm_resource_group3_name' => null,
					'sm_resource_group4_name' => null,
					'sm_resource_group5_name' => null,
