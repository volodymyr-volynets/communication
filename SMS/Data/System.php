...
class System extends \Object\Import {
	public $data = [
		'controllers' => [
			...
			'data' => [
				[
					'sm_resource_id' => '::id::\Numbers\Communication\SMS\Controller\Templates',
					'sm_resource_code' => '\Numbers\Communication\SMS\Controller\Templates',
					'sm_resource_type' => 100,
					'sm_resource_classification' => 'Global',
					'sm_resource_name' => 'S/3 SMS Templates',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'fab fa-medium-m',
					'sm_resource_module_code' => 'S3',
					'sm_resource_group1_name' => 'Operations',
					'sm_resource_group2_name' => 'Communication',
					'sm_resource_group3_name' => 'SMS',
					...
					'\Numbers\Backend\System\Modules\Model\Resource\Features' => [
						[
							'sm_rsrcftr_feature_code' => 'S3::SMS',
		...
		'menu' => [
			...
			'data' => [
				[
					'sm_resource_id' => '::id::\Menu\Operations\Communication\SMS',
					'sm_resource_code' => '\Menu\Operations\Communication\SMS',
					'sm_resource_type' => 299,
					'sm_resource_name' => 'SMS',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'fas fa-sms',
					'sm_resource_module_code' => 'S3',
					'sm_resource_group1_name' => 'Operations',
					'sm_resource_group2_name' => 'Communication',
				...
				[
					'sm_resource_id' => '::id::\Menu\Numbers\Communication\SMS\Controller\Templates',
					'sm_resource_code' => '\Menu\Numbers\Communication\SMS\Controller\Templates',
					'sm_resource_type' => 200,
					'sm_resource_name' => 'SMS Templates',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'fab fa-medium-m',
					'sm_resource_module_code' => 'S3',
					'sm_resource_group1_name' => 'Operations',
					...
					'sm_resource_acl_authorized' => 0,
					'sm_resource_acl_permission' => 1,
					'sm_resource_menu_acl_resource_id' => '::id::\Numbers\Communication\SMS\Controller\Templates',
					'sm_resource_menu_acl_method_code' => 'Index',
					'sm_resource_menu_acl_action_id' => '::id::List_View',
					'sm_resource_menu_url' => '/Numbers/Communication/SMS/Controller/Templates',
					'sm_resource_menu_options_generator' => null,
					'sm_resource_inactive' => 0
				],
			]
