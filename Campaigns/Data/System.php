...
class System extends \Object\Import {
	public $data = [
		'controllers' => [
			...
			'data' => [
				[
					'sm_resource_id' => '::id::\Numbers\Communication\Campaigns\Controller\Advertising\Codes',
					'sm_resource_code' => '\Numbers\Communication\Campaigns\Controller\Advertising\Codes',
					'sm_resource_type' => 100,
					'sm_resource_classification' => 'Global',
					'sm_resource_name' => 'C/A Advertising Codes',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'fab fa-leanpub',
					'sm_resource_module_code' => 'CA',
					'sm_resource_group1_name' => 'Operations',
					'sm_resource_group2_name' => 'Communication',
					'sm_resource_group3_name' => 'Campaigns',
					...
					'\Numbers\Backend\System\Modules\Model\Resource\Features' => [
						[
							'sm_rsrcftr_feature_code' => 'CA::CAMPAIGNS',
		...
		'menu' => [
			...
			'data' => [
				[
					'sm_resource_id' => '::id::\Menu\Operations\Communication\Campaigns',
					'sm_resource_code' => '\Menu\Operations\Communication\Campaigns',
					'sm_resource_type' => 299,
					'sm_resource_name' => 'Campaigns',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'fab fa-pied-piper-hat',
					'sm_resource_module_code' => 'CA',
					'sm_resource_group1_name' => 'Operations',
					'sm_resource_group2_name' => 'Communication',
				...
				[
					'sm_resource_id' => '::id::\Menu\Numbers\Communication\Campaigns\Controller\Advertising\Codes',
					'sm_resource_code' => '\Menu\Numbers\Communication\Campaigns\Controller\Advertising\Codes',
					'sm_resource_type' => 200,
					'sm_resource_name' => 'Advertising Codes',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'fab fa-leanpub',
					'sm_resource_module_code' => 'CA',
					'sm_resource_group1_name' => 'Operations',
					...
					'sm_resource_acl_authorized' => 0,
					'sm_resource_acl_permission' => 1,
					'sm_resource_menu_acl_resource_id' => '::id::\Numbers\Communication\Campaigns\Controller\Advertising\Codes',
					'sm_resource_menu_acl_method_code' => 'Index',
					'sm_resource_menu_acl_action_id' => '::id::List_View',
					'sm_resource_menu_url' => '/Numbers/Communication/Campaigns/Controller/Advertising/Codes',
					'sm_resource_menu_options_generator' => null,
					'sm_resource_inactive' => 0
				],
			]
